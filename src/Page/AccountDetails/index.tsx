...
import FileInput from "@/Page/AccountDetails/Components/FileInput";
import TextInput from "@/Page/AccountDetails/Components/TextInput";
...
function validateYear(value: string, ctx: z.RefinementCtx) {
...
function validateDob(value: string, ctx: z.RefinementCtx) {
...
function validatePartOfSmf(val: "Yes" | "No" | null, ctx: z.RefinementCtx) {
  switch (val) {
    case "Yes":
      return true;
    case "No":
...
function validateFile(fieldName: string) {
  return [
...
type Contribution = (typeof contribution)[number];

export default AccountDetails;
export type { Inputs as AccountDetailsInputs, Contribution };
